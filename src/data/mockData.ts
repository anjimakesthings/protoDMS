...
export const MOCK_WORK_ITEMS: WorkItem[] = [
  ...
  },
  {
    ...
    events: [
      ...
      { type: 'STATUS_CHANGED', timestamp: makeDate(monday, 2, 8, 30), detail: 'IN_PROGRESS' },
      { type: 'STATUS_CHANGED', timestamp: makeDate(monday, 2, 11), detail: 'COMPLETED' },
    ],
    createdAt: makeDate(monday, -4, 14),
    updatedAt: makeDate(monday, 2, 11),
  },
  {
    id: 'WI-006',
    type: 'GENERAL',
    ...
    events: [
      ...
      { type: 'STATUS_CHANGED', timestamp: makeDate(monday, 2, 11), detail: 'IN_PROGRESS' },
    ],
